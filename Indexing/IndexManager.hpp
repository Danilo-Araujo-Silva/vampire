...
enum IndexType {
  ...
  FW_SIMPLIFICATION_SUBST_TREE,
  BW_SIMPLIFICATION_SUBST_TREE,
  FW_SIMPLIFYING_UNIT_CLAUSE_SUBST_TREE,
  ...
  BW_DEMODULATION_SUBTERM_SUBST_TREE,
  FW_DEMODULATION_LHS_SUBST_TREE,

  FW_SUBSUMPTION_CODE_TREE,

  FW_SUBSUMPTION_SUBST_TREE,

  FW_REWRITE_RULE_SUBST_TREE,

  FW_GLOBAL_SUBSUMPTION_INDEX,
...
private:
  ...
  bool _equalSimpContainers; // true if the container simplifyingContainer of _alg is the same as the toBeSimplifiedContainer of _alg
};
